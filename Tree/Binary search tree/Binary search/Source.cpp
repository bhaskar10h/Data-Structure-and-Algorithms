...
int main()
{
    ...
    deletion(root, 25);
    cout << endl;
    cout << "After deleting node 25, the inorder traversal of the given binary tree is - " << endl;
    cout << endl;

    inorder(root);
    insertion(root, 2);
    cout << endl;
    cout << "After inserting node 2, the inorder traversal of the given binary tree is - " << endl;
    cout << endl;
